...
`ifndef COUNT_0_100_STEP_5_TEST__SV 
`define COUNT_0_100_STEP_5_TEST__SV 

class count_0_100_step_5_test extends uvm_test;

    // Register the class count_0_100_step_5_test with the factory.
    `uvm_component_utils(count_0_100_step_5_test)
    ...
    function new(string name="count_0_100_step_5_test", uvm_component parent);
...
endclass: count_0_100_step_5_test


// Define the Build Phase of the Environment
function void count_0_100_step_5_test::build_phase(uvm_phase phase);
...
function void count_0_100_step_5_test::connect_phase(uvm_phase phase);
...
function void count_0_100_step_5_test::end_of_elaboration_phase(uvm_phase phase);
...
function void count_0_100_step_5_test::set_config_parameters();
...
task count_0_100_step_5_test::run_phase(uvm_phase phase);

    // Define a handle to all Virtual Sequences used by the Test.
    count_0_100_step_5_vseq vseq_0;

    super.run_phase(phase);

    // Create all the Virtual Sequences
    vseq_0 = count_0_100_step_5_vseq::type_id::create("vseq_0");
