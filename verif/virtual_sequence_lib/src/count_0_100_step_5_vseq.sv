...
`ifndef COUNT_0_100_STEP_5_VSEQ__SV 
`define COUNT_0_100_STEP_5_VSEQ__SV 

class count_0_100_step_5_vseq extends uvm_sequence#( uvm_sequence_item );
    // Register the class count_0_100_step_5_vseq with the factory.
    `uvm_object_utils(count_0_100_step_5_vseq)

    // Set the handle to the virtual sequencer.
    `uvm_declare_p_sequencer(ahb_config_pcounter_virtual_sequencer)

    // The Constructor for this Class.
    function new(string name="count_0_100_step_5_vseq");
        super.new(name);
    endfunction: new
...
endclass: count_0_100_step_5_vseq 


task count_0_100_step_5_vseq::body();
...
task count_0_100_step_5_vseq::exec_basic_block_0();
