...
# DVE full session
# Saved on Tue Dec 3 15:05:12 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{62 66} {1908 1052}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 245001
gui_list_add_group -id ${Wave.1} -after {New Group} {ahb_slave_interface}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ahb_slave_interface  -position in

gui_marker_move -id ${Wave.1} {C1} 171844
